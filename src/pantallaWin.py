...
FONT_SIZE = 30
IMAGE_BACKGROUND = add_path_file("pantallaWinner.png")
FONT_PATH = add_path_file("Roboto-Medium.ttf") 
...
def draw_message(font):
    ...
    text_width2 = rl.measure_text_ex(font, message2, FONT_SIZE, 1).x
    text_height = FONT_SIZE 

    rl.draw_text_ex(font, message1, rl.Vector2((SCREEN_WIDTH - text_width1) / 2, (SCREEN_HEIGHT - text_height) / 2 - text_height), FONT_SIZE, 0, rl.BLACK)
    rl.draw_text_ex(font, message2, rl.Vector2((SCREEN_WIDTH - text_width2) / 2, (SCREEN_HEIGHT - text_height) / 2 + text_height), FONT_SIZE, 0, rl.BLACK)
